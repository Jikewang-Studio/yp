...
public interface P_to_u_messageMapper {
    Integer countByExample(P_to_u_messageExample example);
    ...
    List<P_to_u_message> selectByUserId(Integer userId);

    P_to_u_message selectByPrimaryKey(Integer userMessageId);
